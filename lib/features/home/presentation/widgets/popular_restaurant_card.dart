...
import 'package:grabit_mobile/features/home/presentation/screen/restaurant_details.dart';
...
class PopularRestaurantCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Clickable(
      onPressed: (){
        context.push(const RestaurantDetails());
      },
      child: SizedBox(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SvgImage(asset: favorite, height: 14, color: Colors.amber),
                Text(
                  rating,
